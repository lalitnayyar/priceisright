...
{json.dumps(export_data, indent=2)}"""
    ...
    with gr.Blocks(
        ...
        theme=gr.themes.Base(
            ...
            font=[gr.themes.GoogleFont("Hanken Grotesk"), "ui-sans-serif", "system-ui", "sans-serif"],
        ...
        with gr.Tabs(elem_id="main-tabs") as tabs:
            ...
            with gr.Tab("🖥️ Dashboard", id="tab-dashboard"):
                ...
                with gr.Accordion("🖥️ Live Dashboard", open=True):
                    gr.HTML('''
                    <iframe
                        src="/static/dashboard_panels.html"
            ...
            with gr.Tab("⚙️ Settings", id="tab-settings"):
                ...
                <iframe
                    ...
                    style="width:100%;height:900px;border:none;background:#1a0d08;"
        ...
        ">
            ...
            <div style="
                ...
                text-align: left;
            ">
                <span style="color:#FF6B35;font-weight:700;font-size:12px;letter-spacing:0.08em;">&#9888; EDUCATIONAL PURPOSE ONLY</span>
                <p style="color:#e1bfb5;font-size:11px;margin:6px 0 0 0;line-height:1.7;">
                    This application is built solely for <strong style="color:#ffb59d;">educational and demonstration purposes</strong>
                    as part of an AI/ML capstone project. It does not constitute financial, investment, or purchasing advice.
                    All deal data, price estimates, and AI-generated outputs are for learning and research only.
                    Use of real API keys and external services is at the user's own discretion and risk.
                </p>
            </div>
            <!-- Author / Contact -->
            <div style="color:#7a5a50;font-size:11px;margin-top:4px;line-height:2;">
                <span style="color:#ffb59d;font-weight:700;letter-spacing:0.05em;">Lalit Nayyar</span>
                &nbsp;&bull;&nbsp;
                <a href="mailto:lalitnayyar@gmail.com" style="color:#5dd9d0;text-decoration:none;">lalitnayyar@gmail.com</a>
                &nbsp;&bull;&nbsp;
                <a href="tel:+971508320336" style="color:#e1bfb5;text-decoration:none;">+971 50 832 0336</a>
                &nbsp;&bull;&nbsp;
                <a href="tel:+919595353336" style="color:#e1bfb5;text-decoration:none;">+91 95953 53336</a>
            </div>
            <!-- Gradio / API links -->
            <div style="color:#594139;font-size:10px;margin-top:10px;">
                <a href="/?view=api" style="color:#594139;text-decoration:none;" target="_blank">Use via API</a>
                &nbsp;&middot;&nbsp;
                <a href="https://gradio.app" style="color:#594139;text-decoration:none;" target="_blank">Built with Gradio</a>
            </div>
        </div>
        """)
